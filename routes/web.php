...
Route::group(['middleware' => ['auth:api']], function() {
    ...
    Route::post('/register-new-user', [App\Http\Controllers\UsersController::class, 'registerUser']);
    ...
    Route::post('/megasoft/{action}', [App\Http\Controllers\DutyController::class, 'megasoft']);
